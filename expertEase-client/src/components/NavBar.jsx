      ...
      <div className="max-w-screen-2xl container mx-auto md:px-20 px-6 md:fixed top-0 right-0 left-0">
        <div className="navbar bg-base-100">
          <div className="navbar-start">
            ...
            <a className=" text-2xl font-bold cursor-pointer text-indigo-700 font-serif">
              ExpertEase
            </a>
          </div>
          <div className="navbar-end space-x-3">
            ...
            <div className="">
              <a className="bg-black text-white px-4 py-3 rounded-lg hover:bg-slate-800 duration-300 cursor-pointer">
                Login
              </a>
            </div>
          </div>
